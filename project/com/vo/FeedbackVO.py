...
class FeedbackVO(db.Model):
    ...
    feedbackDescription = db.Column('feedbackDescription', db.String(300), nullable=False)
    feedbackRating = db.Column('feedbackRating', db.Integer, nullable=False)

    feedbackDate = db.Column('feedbackDate', db.Date, nullable=False)
    feedbackTime = db.Column('feedbackTime', db.Time, nullable=False)
